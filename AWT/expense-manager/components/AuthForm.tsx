        ...
        <div className="relative w-full flex">
              ...
              {mode === "register" && (
                ...
                >
                  ...
                  <form onSubmit={onRegister} className="space-y-2.5">
                    ...
                    {error && (
                      <div className="text-rose-400 text-[9px] font-medium bg-rose-500/10 p-2 rounded-lg border border-rose-500/20">
                        {error}
                      </div>
                    )}
                    <Button
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-8">
            <div className="w-full md:hidden">
                  ...
                  >
                    ...
                    <form onSubmit={onLogin} className="space-y-3 mt-4">
                      ...
                      <Input
                        ...
                        className="h-9"
                      />
                      <Button type="submit" fullWidth className="h-10 mt-2">
                        Login
                      </Button>
                    </form>
                  </motion.div>
              ...
              <button
                onClick={toggleMode}
                className="w-full mt-6 text-[10px] font-medium text-primary uppercase"
              >
                {mode === "login"
                  ? "Create an account"
            ...
            <div className="relative h-full w-full flex flex-col items-center justify-center text-primary-foreground p-6 text-center">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-primary-foreground/60 text-[8px] font-medium uppercase tracking-[0.3em] mb-8">
                    Personal Finance
                  </p>
                  <button
                    onClick={toggleMode}
                    className="group flex items-center gap-2 px-6 py-2 bg-white text-primary rounded-xl text-[10px] font-medium"
                  >
                    {mode === "login" ? (
                      <>
