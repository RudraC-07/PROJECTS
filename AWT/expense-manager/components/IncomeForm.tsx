...
export function IncomeForm({ role, peoples = [] }: { role: string, peoples?: any[] }) {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-emerald-600">Record Income</h1>
          <p className="text-muted-foreground text-sm">Log new project funding or client revenue.</p>
        </div>
      </div>
      ...
      <Card className="shadow-xl border-emerald-500/20 p-8 border-t-4 border-t-emerald-500">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="flex h-10 w-full rounded-md border border-input bg-emerald-500/5 px-8 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
                  placeholder="0.00"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <select 
                ...
                onChange={handleChange}
                className="flex h-10 w-full rounded-md border border-input bg-secondary/30 px-3 py-2 text-sm"
              >
            ...
            <div className="space-y-2">
              ...
              <select 
                ...
                className="flex h-10 w-full rounded-md border border-input bg-secondary/30 px-3 py-2 text-sm disabled:opacity-50"
              >
          ...
          <div className="flex gap-4 pt-4">
            <Button type="submit" disabled={loading} className="flex-1 font-bold h-11 bg-emerald-600 hover:bg-emerald-700" size="lg">
