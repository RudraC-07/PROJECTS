  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link href="/user/expenses/add">
            <Button
              size="sm"
              className="rounded-xl shadow-lg shadow-primary/20 font-medium px-6"
            >
              Add My Expense
            </Button>
          </Link>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-primary uppercase tracking-tighter">
                    Contributor
                  </span>
                </div>
              </div>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="border-t-4 border-t-rose-500 bg-rose-500/[0.02]">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[9px] font-semibold text-rose-600/50 uppercase tracking-widest">
                Outflows
              </span>
            </div>
      ...
      <Card
        ...
        subtitle="Your contributions to this project"
        ...
        {transactions.length > 0 ? (
          ...
          <div className="h-64 flex flex-col items-center justify-center border-2 border-dashed border-border rounded-3xl bg-secondary/5 mt-4">
            ...
            <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">
              You have no records for this project yet
            </p>
          </div>
        )}
      </Card>
